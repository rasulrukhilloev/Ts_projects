...
function () {
  ...
  ApiSync.prototype.save = function (data) {
    var id = data.id;
    if (id) return axios_1.default.put("".concat(this.rootUrl, "/").concat(id), data);else return axios_1.default.post("".concat(this.rootUrl), data);
  };
...
},{"./Attributes":"src/models/Attributes.ts","./ApiSync":"src/models/ApiSync.ts","./Eventing":"src/models/Eventing.ts","./Model":"src/models/Model.ts","./Collection":"src/models/Collection.ts"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
console.log(users); //TODO troubleshoot why user collection is not rendered in DOM
